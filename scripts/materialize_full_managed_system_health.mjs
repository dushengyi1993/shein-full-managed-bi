...
export const SYSTEM_UNIT_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    key: 'homeRealtime',
    label: '首页整点实时',
    service: 'shein-fm-home-realtime.service',
    timer: 'shein-fm-home-realtime.timer',
    kind: 'job',
    critical: true,
    route: 'home',
  }),
  Object.freeze({
    key: 'homeDaily',
    label: '首页昨日收口',
    service: 'shein-fm-home-daily.service',
    timer: 'shein-fm-home-daily.timer',
    kind: 'job',
    critical: true,
    route: 'home',
  }),
  Object.freeze({
    key: 'homeFinanceDaily',
    label: '财务日收口',
    service: 'shein-fm-home-finance-daily.service',
    timer: 'shein-fm-home-finance-daily.timer',
    kind: 'job',
    critical: false,
    route: 'home',
  }),
