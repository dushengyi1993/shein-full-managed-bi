...
const URL_ORDER_PAGE_IDS = Object.freeze([
  'delivery-notes', 'stock-records', 'waybills',
...
const ORDER_FIELD_LABELS = Object.freeze({
  ...
  returnDimensions: '退货维度',
  returnDimensionsName: '退货维度名称',
  originNo: '关联单号',
  returnQuantity: '退货数量',
  returnTotalAmount: '退货总额',
  pricingCurrencyId: '计价币种代码',
  currencyCode: '币种',
  billCurrencyId: '结算币种代码',
  billCurrencyCode: '结算币种',
  returnDealType: '处理方式类型',
  returnDealTypeName: '处理方式',
  returnMode: '退货方式类型',
  returnModeName: '退货方式',
  returnGenerateQuantity: '实际退货数量',
  returnScrappedQuantity: '实际报废数量',
  returnVssQuantity: '增值服务数量',
  warehouseIds: '仓库 ID',
  // return-orders fields
  returnOrderNo: '退货单号',
  returnWayType: '退货方式类型',
  changeReturnWayType: '变更退货方式类型',
  returnWayTypeName: '退货方式',
  returnExpressCompanyCode: '退货物流公司代码',
  returnExpressCompanyName: '退货物流公司',
  expressNoList: '物流单号',
  warehouseId: '收货仓 ID',
  subWarehouseId: '子仓 ID',
  subWarehouseName: '子仓名称',
  returnOrderType: '退货单类型',
  returnOrderTypeName: '退货单类型名称',
  returnOrderStatus: '退货状态码',
  returnOrderStatusName: '退货状态',
  skcNameList: 'SKC 列表',
  supplierCodeList: '供应商代码列表',
  waitReturnQuantity: '待退货数量',
  returnScrapType: '报废类型',
  returnScrapTypeName: '报废类型名称',
  isSign: '是否签收',
  completeTime: '完成时间',
  sellerOrderNo: '卖家订单号',
  sellerOrderNoList: '卖家订单号列表',
  sellerDeliveryNo: '卖家发货单号',
  sellerDeliveryNoList: '卖家发货单号列表',
  returnAmount: '退货金额',
  returnBoxNum: '退货箱数',
  waybillPickupTime: '运单揽收时间',
  waybillSignTime: '运单签收时间',
  updateTime: '更新时间',
  skcNum: 'SKC 数',
  canApplyReconsider: '可否申请复议',
  // exceptions fields
  workorderNo: '工单号',
  categoryId: '异常类目 ID',
  categoryCode: '异常类目代码',
  categoryName: '异常类目',
  firstCategoryCode: '一级类目代码',
  firstCategoryName: '一级类目',
  applyType: '申请类型',
  applyTypeName: '申请类型名称',
  sceneType: '场景类型',
  sceneTypeName: '场景类型名称',
  statusValue: '状态码',
  statusName: '状态',
  createTime: '创建时间',
  externalSystem: '外部系统',
  externalNo: '外部单号',
  workorderType: '工单类型',
  // value-added-services fields
  subOrderNo: '子订单号',
  serviceSiteId: '服务站点 ID',
  serviceSiteName: '服务站点',
  purchaseNo: '采购单号',
  newPurchaseNo: '新采购单号',
  multiPartFlag: '是否多件',
  supplierProductNumber: '供应商货号',
  totalFlag: '汇总标记',
  totalFlagName: '汇总标记名称',
  orderState: '服务状态码',
  orderStateName: '服务状态',
  actualTotalAmount: '实际服务金额',
  lowValueFlag: '低价标记',
  ...
  returnNo: '退货单号',
  deliveryNo: '发货单号',
  vendorReplenishState: '商家补货状态码',
  vendorReplenishStateName: '商家补货状态',
  estimateIncrementAmount: '预计增量金额',
  showFeeTag: '展示费用标记',
  supplierSource: '供应商来源',
  supplierSourceName: '供应商来源名称',
  // quality-reports fields
  purchaseCode: '采购单号',
  hasDefectiveTotal: '是否含次品',
  hasDefectiveTotalName: '次品标记名称',
  inspectionTime: '质检时间',
  defectiveTotalQty: '次品总数',
  qcType: '质检类型',
  qcTypeName: '质检类型名称',
  orderDefectiveTotalQty: '订单次品总数',
  orderQcResult: '订单质检结果',
  orderQcResultName: '订单质检结果名称',
  inspectionResult: '质检结果',
  inspectionResultName: '质检结果名称',
});
  ...
  return `
    ...
    <details class="shipping-source-note">
      ...
      <div>
        ...
        <span>${sourceCapabilities.portalExtensions === true ? '官方页面扩展字段已接入。' : '订单标签、复议和售前异常等扩展字段正在通过 Session HTTP 补充，缺失时不编造。'}</span>
