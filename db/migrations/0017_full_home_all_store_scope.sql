...
-- The homepage history pipeline was proven first with DL5477 and MZ2406.
-- Expand only the store-scope constraints after the canonical 24-store roster
-- and isolated Profile mapping are available in application code. All other
-- data-quality, source and uniqueness constraints remain unchanged.
