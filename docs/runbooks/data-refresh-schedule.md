...
半托每日已授权限时折扣修复在 12、15、16、18、19、21 点使用 `:15–:27`、
`:45–:57` 云端 `browser-write` 车道。全托重任务在对应小时的 `:10–:27`、`:40–:57`
不再新启动，但 OpenAPI 销售、Webhook 和其它轻量 API 任务照常运行。只有每周普通营销
活动报名可在工作量过大时改用本地浏览器；每日限时折扣缺口不得转成本地待办。
